...
- **Irradiance-to-power conversion**: Use the estimated SDM parameters to map the forecasted irradiance to power. See example: [Power_prediction.ipynb](examples/Power_prediction.ipynb)
