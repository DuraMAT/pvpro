...
class Preprocessor():
    ...
    def __init__(self,
        ...
        # self.cal_cell_temp_from_module_temp(delta_T=3) 
    ...
    def run_preprocess_solar_data_tool(self, df,
    ...
    def cal_cell_temp_from_module_temp(self, delta_T : float =3,
    ...
    def classify_operating_condition(self):
        """
